...
struct RiskGaugeSection: View {
    let risk: (level: String, color: Color, score: Int)
    let theme: AppTheme
...
// MARK: - Analysis Empty State View
...
#Preview("RiskGaugeSection") {
    RiskGaugeSection(
        risk: (level: "Low", color: .green, score: 25),
        theme: .purple
    )
    .padding()
}
...
#Preview("AnalysisEmptyStateView") {
