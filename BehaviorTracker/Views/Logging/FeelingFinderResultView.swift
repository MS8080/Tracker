...
struct ResultStep: View {
    ...
    private static let detailToPatterns: [String: [PatternType]] = [
        // Environment
        "Bright or harsh lighting": [.sensoryState, .sensoryEnvironment],
        "Noise level": [.sensoryState, .sensoryEnvironment],
        "Smells": [.sensoryState, .sensoryEnvironment],
        "Temperature uncomfortable": [.sensoryState, .sensoryEnvironment],
        "Too many people around": [.sensoryState, .socialEnergy],
        "Crowded or cluttered space": [.sensoryState],
        "Been in same place too long": [.sensorySeeking, .recovery],
        // Events
        "Upcoming exam or test": [.demandResponse, .avoidance],
        "Job interview": [.demandResponse, .avoidance],
        "Deadline at work or school": [.demandResponse, .avoidance],
        "Public speaking or presentation": [.demandResponse, .avoidance],
        "Social invitation or gathering": [.socialEnergy],
        "Family event or obligation": [.socialEnergy],
        "Conflict or argument that happened": [.connection, .socialRecovery],
        "Something unexpected happened": [.routineChange],
        "Waiting for results or answer": [.overwhelm],
        // Health
        "Heart racing or pounding": [.overwhelm, .regulation],
        "Breathing feels off": [.overwhelm, .regulation],
        "Muscle tension": [.bodySignals],
        "Headache or pressure": [.bodySignals],
        "Fatigue or heaviness": [.burnout, .energyLevel],
        "Restlessness": [.stimming, .regulation],
        "Sensory sensitivity": [.sensoryState],
        "Haven't eaten or slept well": [.sleep, .bodySignals],
        // Social
        "Recent difficult conversation": [.socialEnergy, .socialRecovery],
        "Anticipating social interaction": [.socialEnergy],
        "Feeling isolated or lonely": [.socialRecovery, .connection],
        "Someone is upset with me": [.connection],
        "I'm upset with someone": [.connection],
        "Had to mask or pretend": [.masking],
        "Feeling misunderstood": [.connection],
        "Rejection or criticism": [.overwhelm],
        // Demand
        "Task I keep avoiding": [.avoidance, .taskInitiation],
        "Too many things to do": [.decisions, .burnout],
        "Someone expecting something from me": [.demandResponse],
        "Decision I need to make": [.decisions],
        "Pressure to be productive": [.demandResponse, .autonomy],
        "Responsibility I don't want": [.avoidance, .autonomy]
    ]
